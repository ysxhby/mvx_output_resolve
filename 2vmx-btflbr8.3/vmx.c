...
//    ULONG msrIndex;
    ...
    _WriteVMCS(GUEST_IA32_DEBUGCTL, (ULONG)(ULONG)(msr & 0xFFFFFFFF)); /*elwin此处没有打开btf lbr*/
    ...
    _WriteVMCS(CPU_BASED_VM_EXEC_CONTROL, VmxAdjustControls(CPU_BASED_ACTIVATE_MSR_BITMAP + CPU_BASED_ACTIVATE_IO_BITMAP,MSR_IA32_VMX_PROCBASED_CTLS));  /*elwin*/
	 //应该好好好查查作用  /*elwin*/
...
/*elwin*/
    ...
    ExceptionBitmap |= 1<<BREAKPOINT_EXCEPTION;  /*elwin*/
    ...
    /* Guest RFLAGS */
    //riteVMCS(GUEST_RFLAGS, (_Eflags()|0x00000100));/*elwin*/
	_WriteVMCS(GUEST_RFLAGS, _Eflags());/*elwin*/
